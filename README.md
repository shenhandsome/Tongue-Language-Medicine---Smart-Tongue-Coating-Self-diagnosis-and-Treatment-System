# Tongue-Language-Medicine---Smart-Tongue-Coating-Self-diagnosis-and-Treatment-System
舌语医说-智慧舌苔自主诊疗系统
# 介绍
...
微信开发者工具打开，要修改所有路径名，部分路径名采用的绝对路径，为了方便向后端发信息，需要把详情里面的不校验合法域名等打开，代码在shetai文件夹
